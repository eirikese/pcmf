...
def publisher():
    ...
    corners_data = load_npy_file('/home/eirik/lidar_ws/src/pcmf/maps/selected_points_brattora.npy')
    reference_data = load_npy_file('/home/eirik/lidar_ws/src/pcmf/maps/all_points_brattora.npy')
    ...
    # shift both clouds 200 meters to the left
    corners_data[:,0] -= 200
